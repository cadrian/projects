...
etags \$@ -f \$TAGS --language-force=Tex --extra=+f --fields=+ailmnSz \$(find \$PROJECT_DEVDIR -name tmp -prune -o -name \\*.ly -print) 2>/dev/null|| echo "Brand new project: no file tagged."
