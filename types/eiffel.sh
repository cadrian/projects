...
etags \$@ -f \$TAGS --language-force=Eiffel --extra=+f --fields=+ailmnSz \$(find \$PROJECT_DEVDIR -name test -prune -o -name tmp -prune -o -name \\*.e -print) 2>/dev/null|| echo "Brand new project: no file tagged."
