...
find \$PROJECT_DEVDIR -name tmp -prune -o -name \\*.e -print | etags \$@ -f \$TAGS --language-force=Eiffel --extra=+f --fields=+ailmnSz -L- 2>>\$LOG|| echo "Brand new project: no file tagged."
